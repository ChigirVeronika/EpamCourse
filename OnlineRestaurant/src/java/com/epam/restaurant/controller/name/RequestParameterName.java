package com.epam.restaurant.controller.name;

/**
 * Class contains request parameters names.
 */
public final class RequestParameterName {

    public static final String COMMAND_NAME = "command";

    public static final String I18N = "i18n.restaurant";
    public static final String MESSAGE = "message";
    public static final String LANGUAGE = "language";
    public static final String LOGIN_BLOCKED = "login.blocked";
    public static final String LOGIN_WRONG = "login.wrong";
    ...
    public static final String FOUNDED_USER = "founded_user";
